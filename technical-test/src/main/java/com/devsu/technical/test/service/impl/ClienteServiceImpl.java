package com.devsu.technical.test.service.impl;

import com.devsu.technical.test.dto.ClienteDTO;
import com.devsu.technical.test.entity.Cliente;
import com.devsu.technical.test.enums.GeneroType;
import com.devsu.technical.test.mapper.ClienteMapper;
import com.devsu.technical.test.repository.ClienteRepository;
import com.devsu.technical.test.service.ClienteService;
import com.devsu.technical.test.util.ConflictException;
import com.devsu.technical.test.util.NotFoundException;
		...
		if (cliente.isPresent()) {
			updates.forEach((key, value) -> {
				...
				if (key.equals(GENERO)) {
					value = GeneroType.valueOf(value.toString());
				}
